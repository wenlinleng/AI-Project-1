...
class Stack:
    ...
    def get_distance_to(self, other_stack):
        """
        :param other_stack:
        :return:
        """
    ...
    def is_inline_to(self, other_stack):
        """
        :param other_stack: the stack we want to know if we share a line with
        :return: whether the stacks are inline with each other
        """
